    ...
    <div className={containerClasses}>
      ...
      <div className="flex flex-col gap-2 w-full">
        <div className="relative group">
          <input
            className={cn(
              "w-full px-4 py-2 bg-bg border border-border focus:border-brand focus:ring-1 focus:ring-brand/20 transition-all duration-200 text-sm font-normal outline-none rounded-md placeholder:text-text-muted/40 shadow-sm",
